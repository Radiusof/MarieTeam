...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Feb 01, 2023 at 12:10 PM
...
--
-- Table structure for table `bateauvoyageur`
--
...
--
-- Dumping data for table `bateauvoyageur`
--
...
CREATE TABLE `contenir` (
  `id_categorie` int NOT NULL,
  `id_bateau` int NOT NULL,
  `capaciteMaximum` int DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
INSERT INTO `contenir` (`id_categorie`, `id_bateau`, `capaciteMaximum`) VALUES
(1, 11, 50),
(1, 2, 38),
(1, 45, 48),
(1, 23, 64),
...
INSERT INTO `reservation` (`id_reservation`, `nom`, `adresse`, `cp`, `ville`, `id_traversee`, `id_utilisateur`) VALUES
...
INSERT INTO `traversee` (`id_traversee`, `date_depart`, `heure`, `id_liaison`, `id_bateau`) VALUES
(1, '2023-02-03', NULL, 15, 2);
...
--
-- Indexes for table `bateauvoyageur`
--
